...
public class TransactionManager implements Serializable {
    ...
    // Public methods for external access and testing (JUnit)
    ...
    // NOTE ON SRP: This method mixes Data Filtering (Manager's job) with
    // Presentation (UI/Main's job). In a strict SOLID system, the Main class
    // would call getTransactionsByAccount() and then print the results.
    // Inside TransactionManager.java
